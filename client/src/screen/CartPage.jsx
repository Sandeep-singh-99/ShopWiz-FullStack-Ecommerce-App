...
//                   </div>
//                 </div>
//                 <button className="mt-6 w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition-all duration-200 font-semibold shadow-md">
//                   Proceed to Checkout
//                 </button>
//               </div>
//             </div>
